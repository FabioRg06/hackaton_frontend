...
// UI State Types
export type ViewMode = 'dashboard' | 'contract-list' | 'contract-detail' | 'exploratory' | 'comparison' | 'entity-list' | 'entity-contracts' | 'count' | 'query-result' | 'secop-full-list' | 'secop-table' | 'secop-chart' | 'high-risk-contract-list' | 'analysis-report' | 'schema-info' | 'field-values'
